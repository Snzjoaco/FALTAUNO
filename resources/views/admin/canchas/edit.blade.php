...
@section('title', 'Editar Cancha - FaltaUno')
@section('page-title', 'Editar Cancha: ' . $cancha->nombre)
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">
                    <i class="fas fa-edit me-2"></i>Editar Información de la Cancha
                </h5>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('admin.canchas.update', $cancha->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('tipo_cancha') is-invalid @enderror" 
                                ...
                                <option value="f5" {{ old('tipo_cancha', $cancha->tipo_cancha) === 'f5' ? 'selected' : '' }}>F5 (5 vs 5)</option>
                                <option value="f7" {{ old('tipo_cancha', $cancha->tipo_cancha) === 'f7' ? 'selected' : '' }}>F7 (7 vs 7)</option>
                                <option value="f11" {{ old('tipo_cancha', $cancha->tipo_cancha) === 'f11' ? 'selected' : '' }}>F11 (11 vs 11)</option>
                                <option value="mixto" {{ old('tipo_cancha', $cancha->tipo_cancha) === 'mixto' ? 'selected' : '' }}>Mixto</option>
                            </select>
                            @error('tipo_cancha')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <textarea class="form-control @error('descripcion') is-invalid @enderror" 
                                      ...
                                      placeholder="Describe las características de tu cancha...">{{ old('descripcion', $cancha->descripcion) }}</textarea>
                            @error('descripcion')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <input type="text" class="form-control @error('direccion') is-invalid @enderror" 
                                   id="direccion" name="direccion" value="{{ old('direccion', $cancha->direccion) }}" 
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control @error('ciudad') is-invalid @enderror" 
                                   id="ciudad" name="ciudad" value="{{ old('ciudad', $cancha->ciudad) }}" 
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control @error('barrio') is-invalid @enderror" 
                                   id="barrio" name="barrio" value="{{ old('barrio', $cancha->barrio) }}" 
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control @error('codigo_postal') is-invalid @enderror" 
                                   id="codigo_postal" name="codigo_postal" value="{{ old('codigo_postal', $cancha->codigo_postal) }}" 
                                   placeholder="Se completará automáticamente..." readonly>
                            @error('codigo_postal')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" step="any" class="form-control @error('latitude') is-invalid @enderror" 
                                   id="latitude" name="latitude" value="{{ old('latitude', $cancha->latitude) }}" 
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" step="any" class="form-control @error('longitude') is-invalid @enderror" 
                                   id="longitude" name="longitude" value="{{ old('longitude', $cancha->longitude) }}" 
                                   placeholder="Se llenará automáticamente" required readonly>
                            @error('longitude')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('tipo_superficie') is-invalid @enderror" 
                                ...
                                <option value="cesped_natural" {{ old('tipo_superficie', $cancha->tipo_superficie) === 'cesped_natural' ? 'selected' : '' }}>Césped Natural</option>
                                <option value="cesped_sintetico" {{ old('tipo_superficie', $cancha->tipo_superficie) === 'cesped_sintetico' ? 'selected' : '' }}>Césped Sintético</option>
                                <option value="cemento" {{ old('tipo_superficie', $cancha->tipo_superficie) === 'cemento' ? 'selected' : '' }}>Cemento</option>
                                <option value="parquet" {{ old('tipo_superficie', $cancha->tipo_superficie) === 'parquet' ? 'selected' : '' }}>Parquet</option>
                            </select>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control @error('capacidad_maxima') is-invalid @enderror" 
                                   id="capacidad_maxima" name="capacidad_maxima" value="{{ old('capacidad_maxima', $cancha->capacidad_maxima) }}" 
                                ...
                                <div class="col-md-3">
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input" type="checkbox" id="tiene_vestuarios" 
                                               name="tiene_vestuarios" value="1" {{ old('tiene_vestuarios', $cancha->tiene_vestuarios) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-3">
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input" type="checkbox" id="tiene_estacionamiento" 
                                               name="tiene_estacionamiento" value="1" {{ old('tiene_estacionamiento', $cancha->tiene_estacionamiento) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-3">
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input" type="checkbox" id="tiene_iluminacion" 
                                               name="tiene_iluminacion" value="1" {{ old('tiene_iluminacion', $cancha->tiene_iluminacion) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-3">
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input" type="checkbox" id="tiene_techado" 
                                               name="tiene_techado" value="1" {{ old('tiene_techado', $cancha->tiene_techado) ? 'checked' : '' }}>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control @error('precio_base') is-invalid @enderror" 
                                       id="precio_base" name="precio_base" value="{{ old('precio_base', $cancha->precio_base) }}" 
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control @error('precio_pico') is-invalid @enderror" 
                                       id="precio_pico" name="precio_pico" value="{{ old('precio_pico', $cancha->precio_pico) }}" 
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control @error('precio_valle') is-invalid @enderror" 
                                       id="precio_valle" name="precio_valle" value="{{ old('precio_valle', $cancha->precio_valle) }}" 
                                       min="0" max="99999999" step="0.01">
                            </div>
                            <div class="form-text">Máximo: $99,999,999.99</div>
                            @error('precio_valle')
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control @error('anticipacion_minima_horas') is-invalid @enderror" 
                                   ...
                                   value="{{ old('anticipacion_minima_horas', $cancha->anticipacion_minima_horas) }}" min="1" max="168" required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control @error('anticipacion_maxima_dias') is-invalid @enderror" 
                                   ...
                                   value="{{ old('anticipacion_maxima_dias', $cancha->anticipacion_maxima_dias) }}" min="1" max="365" required>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-check">
                                ...
                                <input class="form-check-input" type="checkbox" id="permite_cancelacion" 
                                       name="permite_cancelacion" value="1" {{ old('permite_cancelacion', $cancha->permite_cancelacion) ? 'checked' : '' }}>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control @error('horas_cancelacion_gratuita') is-invalid @enderror" 
                                   ...
                                   value="{{ old('horas_cancelacion_gratuita', $cancha->horas_cancelacion_gratuita) }}" min="0" max="168">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control @error('porcentaje_penalidad_cancelacion') is-invalid @enderror" 
                                   ...
                                   value="{{ old('porcentaje_penalidad_cancelacion', $cancha->porcentaje_penalidad_cancelacion) }}" min="0" max="100" step="0.01">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-2">
                                    <div class="position-relative">
                                        <img src="{{ Storage::url($imagen) }}" alt="Imagen {{ $index + 1 }}" 
                                             class="img-thumbnail" style="width: 100%; height: 150px; object-fit: cover;">
                                        <div class="position-absolute top-0 end-0 p-1">
                                            <button type="button" class="btn btn-sm btn-danger" 
                                                    onclick="removeImage({{ $index }})" title="Eliminar imagen">
                            ...
                            <div class="form-text">Las imágenes marcadas con X serán eliminadas al guardar</div>
                        </div>
                        @endif
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="tel" class="form-control @error('telefono') is-invalid @enderror" 
                                   id="telefono" name="telefono" value="{{ old('telefono', $cancha->telefono) }}">
                            @error('telefono')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="email" class="form-control @error('email') is-invalid @enderror" 
                                   id="email" name="email" value="{{ old('email', $cancha->email) }}">
                            @error('email')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="url" class="form-control @error('sitio_web') is-invalid @enderror" 
                                   id="sitio_web" name="sitio_web" value="{{ old('sitio_web', $cancha->sitio_web) }}" 
                                   placeholder="https://...">
                            @error('sitio_web')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="d-flex justify-content-end gap-2">
                                ...
                                <a href="{{ route('admin.canchas.show', $cancha->id) }}" class="btn btn-info">
                                    <i class="fas fa-eye me-2"></i>Ver Cancha
                                </a>
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save me-2"></i>Actualizar Cancha
                                </button>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    function initMap() {
        // Obtener coordenadas actuales de la cancha
        const currentLat = parseFloat(document.getElementById('latitude').value) || -34.6037;
        const currentLng = parseFloat(document.getElementById('longitude').value) || -58.3816;
    ...
    function showLocationSuccess() {
        ...
        if (!successMsg) {
            ...
            successMsg.innerHTML = '<i class="fas fa-check-circle me-2"></i>Ubicación actualizada correctamente';
    ...
    // Función para manejar eliminación de imágenes
    function removeImage(index) {
        removedImages.push(index);
        
        // Marcar visualmente como eliminada
        const imageElement = document.querySelector(`img[alt="Imagen ${index + 1}"]`);
        if (imageElement) {
            imageElement.style.opacity = '0.5';
            imageElement.style.border = '3px solid red';
        }
        
        // Agregar campo hidden para indicar que se eliminó
